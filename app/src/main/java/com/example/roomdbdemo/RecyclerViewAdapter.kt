...
class RecyclerViewAdapter(private val clickHandler: (WatchItem)->Unit): RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.bind(watchList[position], clickHandler)
    }
...
class MyViewHolder(private val view: View) : ViewHolder(view){
    fun bind(watchItem: WatchItem, clickHandler: (WatchItem)->Unit){
